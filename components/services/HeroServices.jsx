...
const HeroServices = () => {
    return (
        <div>
            ...
            <section
                className={` h-screen relative bg-cg-black  bg-cover bg-center bg-no-repeat`}
            >

                <Navbar />
                <div
                    className="relative mx-auto max-w-screen-xl px-4 pt-32 sm:px-6 lg:flex  lg:items-center lg:px-8"
                >
                ...
                <div className="px-4 max-w-screen-xl mx-auto lg:px-8">
                    <p className="my-6 dark:text-gray-400 text-lg font-semibold md:py-16 text-cg-white">
