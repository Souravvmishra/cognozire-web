...
const More = ({text}) => {
    return (
        <div className=''>
            <button className="button mx-auto bg-cg-blue border-2  px-4 py-2 flex justify-center items-center space-x-3 rounded-lg text-cg-white hover:ring hover:ring-blue-600 duration-300 scale-75 md:scale-90 lg:scale-100 ">
